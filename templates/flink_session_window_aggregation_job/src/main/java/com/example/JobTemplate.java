 ...
 *
 * <p>This template shows keyed event-time session-window aggregation. Placeholder values are
 * injected by `flink-app-agent`.
 */
final class JobTemplate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<{{OUTPUT_EVENT_NAME}}> aggregatedEvents = env
                ...
                .window(EventTimeSessionWindows.withGap(Time.minutes({{TIME_WINDOW_MINUTES}})))
